                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="portfolio-nav">
                                <ul>
                                    ...
                                    <li  onClick={() => setCurrentCategory({ name: "works" })} ><span>6</span><i class="fa fa-user"></i>My works</li>
                                    <li onClick={() => setCurrentCategory ({ name: "group" })} ><span>2</span><i class="fa fa-users"></i>Group projects</li>
                                </ul>
                            </div>
